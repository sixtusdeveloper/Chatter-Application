...
//             <p className="text-white-100 text-md">Chatter is a modern communication 
//               platform designed to streamline interactions and enhance collaboration 
//               wiith intuitive features and a user-friendly interface.
//             </p>
//           </div>
//           <div>
//             <h3 className="text-xl font-bold mb-4">Newsletter</h3>
//             <form className="flex items-center">
//                 <input type="email" placeholder="Your email address" required className="py-2 px-4 mr-2 ring-1 bg-black-100 text-white-100 rounded-md outline-none focus:ring-2 focus:ring-blue-500"/>
//                 <button type="submit" className="py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Subscribe</button>
//             </form>
//           </div>
//         </div>
...
//             <p className="text-white-100 text-md">Email: contact@chatterapp.com<br />Phone: +1234567890</p>
//           </div>
//         </div>
//       </div>
//       <div className='flex justify-center items-center border-t py-4 mt-2 md:mt-6'>
//          <span className='w-full flex flex-col text-center text-white-100 text-sm p-2 tracking-wider'>Copyright&copy; 2024. developed by Sixtusdev | all rights reserved | terms & conditions.</span>
//       </div>
//     </footer>
//   );
// };
